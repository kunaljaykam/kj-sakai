...
class SakaiSearch extends SakaiElement {
            ...
            <div class="offcanvas-body">
              <label class="visually-hidden" for="sakai-searchField">Enter search term to search Sakai</label>
                 <div class="input-group position-relative" role="search">
                    <input class="sakaiSearch form-control" type="search"
                        autocomplete="off"
                        ...
                        placeholder="Enter Search term to search Sakai">
  ...
  // trigger sakai search input when sakai search button is clicked
  handleButtonClick(e) {
